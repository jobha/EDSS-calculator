...
export const translations = {
  en: {
    ...
    unableCoordinatedMovements: "unable coordinated movements",
    ataxia34Limbs: "ataxia 3-4 limbs",
    needsAssistance: "needs assistance",
    limbAtaxiaAffectsFunction: "limb ataxia affects function",
    tremorAtaxiaOnTesting: "tremor/ataxia on testing",
    vib: "vib",
    painTouch: "pain/touch",
    jointPos: "joint pos",
    intermittentCath: "intermittent cath",
    needsHelpForBM: "needs help for BM",
    markedlyReducedCognition: "markedly reduced cognition",
    moderatelyReducedCognition: "moderately reduced cognition",
    lightlyReducedCognition: "lightly reduced cognition",
    // Severity levels
    mild: "mild",
    moderate: "moderate",
    marked: "marked",
  ...
  no: {
    ...
    unableCoordinatedMovements: "ute av stand til koordinerte bevegelser",
    ataxia34Limbs: "ataksi 3-4 ekstremiteter",
    needsAssistance: "trenger hjelp",
    limbAtaxiaAffectsFunction: "ekstremitetsataksi påvirker funksjon",
    gaitAtaxia: "gangataksi",
    truncalAtaxia: "trunkal ataksi",
    tremorAtaxiaOnTesting: "tremor/ataksi ved testing",
    rombergFall: "Romberg-fall",
    tandemWalkDifficulty: "tandemgangvanske",
    vib: "vib",
    painTouch: "smerte/berøring",
    jointPos: "leddposisjon",
    lossBladderFunction: "tap blærefunksjon",
    lossBowelFunction: "tap tarmfunksjon",
    permanentCatheter: "permanent kateter",
    bowelIncontinenceWeekly: "tarminkontinens ukentlig",
    frequentIncontinence: "hyppig inkontinens",
    intermittentCath: "intermitterende kat",
    needsHelpForBM: "trenger hjelp til avføring",
    moderateUrge: "moderat urge",
    moderateConstipation: "moderat forstoppelse",
    rareIncontinence: "sjelden inkontinens",
    severeConstipation: "alvorlig forstoppelse",
    mildUrge: "mild urge",
    mildConstipation: "mild forstoppelse",
    pronouncedDementia: "uttalt demens",
    markedlyReducedCognition: "markert redusert kognisjon",
    moderatelyReducedCognition: "moderat redusert kognisjon",
    lightlyReducedCognition: "lett redusert kognisjon",
    moderateSevereFatigue: "moderat-alvorlig fatigue",
